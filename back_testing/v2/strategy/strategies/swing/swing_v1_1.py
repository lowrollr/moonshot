...
class swing_v(Strategy):
    def __init__(self):
        ...
        self.is_ml = False
        self.diff_up = Param(0.01, 0.08, 2, 'diff_up', 0.02)
        self.diff_down = Param(0.01, 0.1, 2, 'diff_down', 0.02)
        self.up_macd = Param(-20, 10, 2, 'up_macd', -8.42)
        self.down_macd = Param(-5, 25, 2, 'down_macd', 18.14)
        self.stop_loss = 0.0
        self.entry = 0.0
        sma_period = Param(5, 1000, 0, 'period', 78)
        ema_fast = Param(5, 1000, 0, 'ema_fast', 446)
        ema_slow= Param(6, 1000, 0, 'ema_slow', 355)
        signal = Param(5, 1000, 0, 'signal', 357)
